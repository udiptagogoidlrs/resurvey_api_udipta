...
$imagick->readImage($file_path_tobe_signed); //$imagick can read pdf and image too
...
for($i=0; $i<$num_pages; $i++) {
    ...
    if($user_desig_code == 'LM'){
        ...
        $pdf->MultiCell(40, 10, $digital_sign, 0, '', 0, 1, 157, 255, true);
        ...
        $pdf->setSignatureAppearance(140, 255, 60, 17, $num_pages, $sign_users->sk->user_name); //X,Y,Width,Height
        $pdf->MultiCell(40, 10, $digital_sign, 0, '', 0, 1, 157, 255, true);
    }else if($user_desig_code == 'CO'){
        //CO SIGNATURE
        $digital_sign = 'Digitally Signed by: '. $sign_users->co->user_name . ' (CO)' . "\n" . 'Date: ' . date('d-m-Y') . "\n" . date('h:i a');
        $pdf->SetFont('freeserif', '', $font_size, '', false);
        $pdf->setSignatureAppearance(140, 255, 60, 17, $num_pages, $sign_users->co->user_name); //X,Y,Width,Height
        $pdf->MultiCell(40, 10, $digital_sign, 0, '', 0, 1, 157, 255, true);
    }else if($user_desig_code == 'ADC'){
        //ADC SIGNATURE
        $digital_sign = 'Digitally Signed by: '. $sign_users->adc->user_name . ' (ADC)' . "\n" . 'Date: ' . date('d-m-Y') . "\n" . date('h:i a');
        $pdf->SetFont('freeserif', '', $font_size, '', false);
        $pdf->setSignatureAppearance(140, 255, 60, 17, $num_pages, $sign_users->adc->user_name); //X,Y,Width,Height
        $pdf->MultiCell(40, 10, $digital_sign, 0, '', 0, 1, 157, 255, true);
    }else if($user_desig_code == 'DC'){
        //DC SIGNATURE
        $digital_sign = 'Digitally Signed by: '. $sign_users->dc->user_name . ' (DC)' . "\n" . 'Date: ' . date('d-m-Y') . "\n" . date('h:i a');
        $pdf->SetFont('freeserif', '', $font_size, '', false);
        $pdf->setSignatureAppearance(140, 255, 60, 17, $num_pages, $sign_users->dc->user_name); //X,Y,Width,Height
        $pdf->MultiCell(40, 10, $digital_sign, 0, '', 0, 1, 157, 255, true);
    }
}
...
//     $digital_sign = 'LM Name: '. $sign_users->lm->user_name;
...
//     //SK SIGNATURE
//     $digital_sign = 'Digitally Signed by: '. $sign_users->sk->user_name . ' (SK)' . "\n" . 'Date: ' . date('d-m-Y') . "\n" . date('h:i a');
//     $pdf->SetFont('freeserif', '', $font_size, '', false);
//     $pdf->setSignatureAppearance(40, 255, 35, 17, $num_pages, $sign_users->sk->user_name); //X,Y,Width,Height
