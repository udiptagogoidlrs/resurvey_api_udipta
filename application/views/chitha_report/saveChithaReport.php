...
<div class='chitha_report container-fluid'>
    ...
    <center>
        ...
        <?php 
         if($single_dag=='1')
            {
                $dag_no=substr($dag_no_lower,  0, -2);?>

         <div class="text-right"> 
                <a target="blank" href='<?php echo base_url() ?>index.php/Chithacontrol/viewDownloads?uuid=<?php echo $uuid->uuid ?>&dag_no=<?php echo $dag_no ?>' class="btn btn-success">
