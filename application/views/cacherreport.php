...
<div class="container">
  <div class="card col-md-10" id="loc_save">
    ...
    <?php echo form_open('VillageController/getvillagedetails'); ?>
...
<input type="hidden" name="base" id="base" value='<?php echo $base ?>'/>
       <div class="text-center"><input type='submit' class="btn btn-primary" id="loc_save" name="submit" value="Submit"></input></div>
     <?php echo form_close(); ?>
       </div>
</div>
</div>
