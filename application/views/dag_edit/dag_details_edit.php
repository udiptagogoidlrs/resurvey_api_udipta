        ...
        <div class="row bg-light border border-secondary mb-3">
            <div class="col-12 px-0 pb-3">
                ...
                <div class="bg-info text-white text-center py-2">
                    <h5>Edit Dag No <?php echo ($dag->dag_no) ?></h5>
                ...
                <div class="table-responsive">
                    <table class="table">
                        <tr>
                            <td>Old Dag No:</td>
                            <td>
                                <input readonly type="text" class="form-control form-control-sm " value="<?php echo $dag->old_dag_no ?>" name="old_dag_no">
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input id="new_dag_no" type="text" value="<?php echo $dag->dag_no ?>" class="form-control form-control-sm" name="new_dag_no">
                                <span class="text-danger"><?= form_error("dag_no") ?></span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Patta Type: <span class="text-danger">*</span>
                            </td>
                            <td>
                                <select disabled name="patta_type_code" id="patta_type_code" class="form-control">
                        ...
                        <tr>
                            <td>
                                Patta No: <span class="text-danger">*</span>
                            </td>
                            <td>
                                <input readonly type="text" class="form-control form-control-sm" value="<?php echo ($dag->patta_no) ?>" id="patta_no" name="patta_no">
                        ...
                        <?php if (($this->session->userdata('dist_code') == '21') || ($this->session->userdata('dist_code') == '22') || ($this->session->userdata('dist_code') == '23')) { ?>
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_b) ?>" class="form-control form-control-sm bklB" id="dag_area_bigha" name="dag_area_b">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_k) ?>" class="form-control form-control-sm bklB" id="dag_area_katha" name="dag_area_k">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_lc) ?>" class="form-control form-control-sm bklB" id="dag_area_lessa" name="dag_area_lc">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_g) ?>" class="form-control form-control-sm bklB" id="dag_area_ganda" name="dag_area_g">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_are) ?>" class="form-control form-control-sm areB" id="dag_area_are_b" name="dag_area_r">
                        ...
                        <?php } else { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_b) ?>" class="form-control form-control-sm bkl bigha" id="dag_area_bigha" name="dag_area_b">
                                    <span class="text-danger"><?= form_error("dag_area_b") ?></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_k) ?>" class="form-control form-control-sm bkl katha" id="dag_area_katha" name="dag_area_k">
                                    <span class="text-danger"><?= form_error("dag_area_k") ?></span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input readonly type="text" value="<?php echo ($dag->dag_area_lc) ?>" class="form-control form-control-sm bkl lessa" id="dag_area_lessa" name="dag_area_lc">
                                    <span class="text-danger"><?= form_error("dag_area_lc") ?></span>
                                </td>
                            </tr>
            ...
            <div class="col-12 text-center pb-3">
                ...
                <button id="update_submit_btn" class="btn btn-primary" type="button" onclick="updateExistingDag()">SUBMIT</button>
                <a class="btn btn-info" href="<?= base_url(); ?>index.php/ChithaDagEditController/viewPattadars">NEXT</a>
            </div>
        </div>
    </form>
</div>
