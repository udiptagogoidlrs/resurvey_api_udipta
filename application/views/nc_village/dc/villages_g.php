    ...
    function alpineData() {
        return {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/getVillagesG',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <select x-model="filter_status" id="filter_status" class="form-control form-control-sm">
                        ...
                        <option value="dc_verified">Verified</option>
                    </select>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <template x-for="(village,index) in villages">
                                    <tr>
                                        ...
                                        <td>
                                            <b>
                                                <small class="text-warning" x-show="village.status == 'G'">Pending</small>
                                                <small class="text-success" x-show="village.status == 'I'">Verified & Signed</small>
                                            </b>
                                        </td>
                                        <td>
                                            <a class="btn btn-sm btn-info text-white no-wrap" x-bind:href=base_url+"index.php/nc_village/NcVillageDcController/showDags?application_no="+village.application_no>Proceed <i class=" fa fa-chevron-right"></i></a>
                                        </td>
                                    </tr>
                                </template>
