...
<script src="<?php echo base_url('assets/plugins/dsign/js/dsc-signer.js') ?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/plugins/dsign/js/dscapi-conf.js') ?>" type="text/javascript"></script>
    ...
    function alpineData() {
        return {
            ...
            init() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/getShowDagsVillage',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            signChitha() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/getBaseSFile',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            storeSignedChitha(jsonData, sign_key) {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/storeSignedPdf',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            signMap(map) {
                ...
                this.loadPreviewForSign('<?= base_url() ?>index.php/nc_village/NcVillageDcController/getMapForSign?id=' + map.id);
                this.sign_type = 'map';
            ...
            signMapConfirm(type) {
                ...
                if (type == 'nicd') {
                    ...
                    $.ajax({
                        url: '<?= base_url() ?>index.php/nc_village/NcVillageDcController/viewUploadedMapBase',
                        method: "POST",
                        async: true,
                        data: {
            ...
            initAdhaarSign() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/adhaar-sign-process',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: data,
            ...
            storeSignedMap(jsonData, sign_key) {
                ...
                $.ajax({
                    ...
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/storeSignedMap',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            getDags() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/getDags',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
                ...
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/certifyVillage',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
            ...
            revertVillage() {
                ...
                $.confirm({
                    title: 'Confirm',
                    content: 'Please confirm to Revert Back this Village to CO',
                    type: 'orange',
                    typeAnimated: true,
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/revertVillage',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    dataType: 'json',
                                    url: self.base_url + "index.php/change_village/ChangeVillageDcController/changeVillageSubmit",
                                    data: {
                    ...
                    <div class=" border-top border-dark mt-3 pt-2 form-group">
                        ...
                        <div class="form-group">
                            <div class="form-group mt-2 row">
                                ...
                                <?php endif; ?>
                                <div x-show="nc_village.status == 'G' || nc_village.status == 'f' ||nc_village.status == 'B' " class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <div class="form-group">
                        ...
                        <div class="pb-3" x-show="nc_village.dc_verified != 'Y' && (nc_village.status == 'G' || nc_village.status == 'f')">
                            ...
                            <button x-on:click="revertVillage" class="btn btn-danger" type="button"><i class="fa fa-backward"></i> Revert Back</button>
                        </div>
