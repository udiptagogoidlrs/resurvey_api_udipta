	...
	function alpineData() {
		return {
			...
			getVillages() {
				...
				$.ajax({
					url: '<?= base_url(); ?>index.php/nc_village/NcVillageDcController/getVillagesM',
					method: "POST",
					async: true,
					dataType: 'json',
	...
	<div class="card">
		<div class="card-body">
			<div class="d-flex justify-content-between align-items-center mb-1">
				<div>
					<h5> FORWARDED TO JDS FOR NAME CHANGE ON MAP
			...
			<table class="table table-hover table-sm">
				...
				<template x-for="(village,index) in villages">
					<tr>
						...
						<td x-text="village.jds_verified == 'Y' ? 'Yes' : 'No'"></td>
						<td x-text="village.jds_note"></td>
						<td x-text="village.ads_verified == 'Y' ? 'Yes' : 'No'"></td>
