	...
	function alpineData() {
		return {
			...
			init() {
				...
				this.dist_code = locations.dist_code;
			},
			getSubdiv() {
				var self = this;
				$.ajax({
...
<!--										<small class="text-warning" x-show="village.status == 'G'">Pending</small>-->
								...
								<td>
									<a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village/NcVillageAdsController/showDags?application_no="+village.application_no+"&dist="+village.dist_code>Proceed <i class=" fa fa-chevron-right"></i></a>
								</td>
							</tr>
						</template>
