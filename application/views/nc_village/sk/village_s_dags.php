    ...
    function alpineData() {
        return {
            ...
            getDags() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageSkController/getDags',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            certifyVillage() {
                ...
                if (!this.sk_note) {
                    alert('Please enter the SK Note');
                    return;
                }
                var self = this;
                this.is_loading = true;
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageSkController/certifyVillage',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
            ...
            revertVillage() {
                ...
                $.confirm({
                    title: 'Confirm',
                    content: 'Please confirm to Revert Back this Village to LM',
                    type: 'orange',
                    typeAnimated: true,
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageSkController/revertVillage',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                ...
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageSkController/verifyDraftChitha',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                ...
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover table-sm table-bordered">
                            <thead style="position: sticky;top:0;" class="bg-warning">
                                <tr>
                                    ...
                                    <th>Occupiers</th>
                                    <th>Area(B-K-L)</th>
                                    <th>Verified By LM <br>(Draft Chitha & Map)</th>
                                    <th>Verified By LM</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="border-top border-dark col-lg-12 col-md-12 py-3" x-show="nc_village.sk_verified != 'Y' && nc_village.status != 'U'">
                        ...
                        <div class="form-group">
                            <label for="" class="form-label">SK Note <span class="text-red">*</span></label>
                            <textarea x-model="sk_note" placeholder="SK Note" rows="2" class="form-control"></textarea>
                        </div>
                        ...
                        <button x-on:click="revertVillage" class="btn btn-danger" type="button"><i class="fa fa-backward"></i> Revert Back to LM</button>
                    </div>
                    ...
                    <div x-show="nc_village.status == 'U'">
                        <h5 class="text-danger mt-5 text-center">This village has been reverted back to LM</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-xl" style="width: 100% !important;">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <h3 x-show="verified == 'Y' || (dags.length == dags_verified)" class="text-success">Draft Chitha Already Verified by SK.</h3>
                        ...
                        <tbody>
                            <?php foreach ($maps as $key => $map_single) : ?>
                                <tr>
                                    <td><?= $key + 1 ?></td>
                                    <td>
                                        <a href="<?= base_url() . 'index.php/nc_village/NcVillageSkController/viewUploadedMap?id=' . $map_single->id ?>" class="btn btn-info py-2" style="color: white" target="_blank">
                                            View Map
                                        </a>
                                    </td>
                                </tr>
