		...
		<div class="card-body">
			<table class="table table-striped table-hover table-bordered">
				<tr class="">
					...
					<td><a class="btn  btn-sm btn-info" href="<?php echo base_url() . 'index.php/nc_village/NcVillageSkController/showVillages'; ?>" style="float:right">Go</a></td>
				</tr>
				<tr class="">
					...
					<td><a class="btn  btn-sm btn-info" href="<?php echo base_url() . 'index.php/nc_village/NcVillageSkController/revertedVillages'; ?>" style="float:right">View</a></td>
				</tr>
				<tr class="">
					<td>Notifications</td>
					<td><?php
