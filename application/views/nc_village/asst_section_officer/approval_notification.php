...
<div class="A4" style="font-size: 12pt;">
	<table>
		...
		<tr>
			<td width="15%"></td>
			<td width="75%">The Assistant Section Officer of Assam,<br>
	...
	<table style="width:100%; border-collapse:collapse;">
		<tr>
			...
			<td style="border: 1px solid black; padding: 2px;">Proposed Cadastral Village Name</td>
		</tr>
	...
	<table style="width:100%;" class="no-page-break">
		...
		<tr>
			<td widtd="100%" style="padding-top: 10px"></td>
			<td widtd="100%" style="padding-top: 10px;text-align: right;"><?= $user_name; ?></td>
		</tr>
		<tr>
			<td  widtd="100%" style="padding-top: 80px"></td>
			<td widtd="100%" style="padding-top: 80px;text-align: right;">Assistant Section Officer, Assam.</td>
		</tr>
		<tr>
			<td widtd="100%"></td>
