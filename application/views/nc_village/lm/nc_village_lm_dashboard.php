		...
		<div class="card-body">
			<table class="table table-striped table-hover table-bordered">
				<tr class="">
					...
					<td><a class="btn btn-sm btn-info" href="<?php echo base_url() . 'index.php/nc_village/NcVillageLmController/pendingVillages'; ?>" style="float:right">Go</a></td>
				</tr>

				<tr class="">
					<td>Reverted Back from <?= SK_LABEL ?></td>
					<td><?php
						echo "<span class=\"badge badge-danger\">$reverted</span>";
						?>
					</td>
					<td><a class="btn btn-sm btn-info" href="<?php echo base_url() . 'index.php/nc_village/NcVillageLmController/revertedVillages' ?>" style="float:right">view</a></td>
				</tr>
				<tr class="">
					<td>Notifications</td>
					<td><?php
