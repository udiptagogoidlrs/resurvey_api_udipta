    ...
    function alpineData() {
        return {
            ...
            portVill(village) {
                ...
                $.confirm({
                    title: 'Confirm',
                    content: 'Please Confirm To Port VLB Data to Dharitree of ' + village.vill_townprt_code,
                    type: 'orange',
                    typeAnimated: true,
                    buttons: {
                        Ok: {
                            ...
                            action: function() {
                                ...
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillagePortingController/portVlbDataToDharitree',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: data,
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillagePortingController/villagedetailsVlb',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: data,
...
<div class="col-lg-12 col-md-12" x-data="alpineData()">
    <div class="text-center p-2 mb-2" style="font-size:18px; font-weight: bold; background-color: #4298c9">Port VLB Data to Dharitree</div>
    <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <div>
                                    <h5> Porting VLB Data to Dharitree
