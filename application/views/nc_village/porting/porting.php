                    ...
                    buttons: {
                        Ok: {
                            ...
                            action: function() {
                                ...
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillagePortingController/portVillageToDharitree',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: data,
...
<div class="col-lg-12 col-md-12" x-data="alpineData()">
    <div class="text-center p-2 mb-2" style="font-size:18px; font-weight: bold; background-color: #4298c9">Porting Village Data to Dharitree</div>
    <div class="row">
