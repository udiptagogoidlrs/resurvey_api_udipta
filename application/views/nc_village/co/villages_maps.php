                ...
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/forwardToLm',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                            ...
                            <tbody>
                                ...
                                <template x-for="(village,index) in villages">
                                    <tr>
                                        ...
                                        <td>
                                            <button data-toggle="modal" data-target="#modal_views_map_lists" x-on:click="openMapListsModel(village)" class="btn btn-sm btn-primary no-wrap"> <i class="fa fa-eye"></i> View Maps</button>
                                        </td>
                                        <td>
                                            <button x-bind:disabled="is_forwarding" x-show="village.flag == 'F'" type="button" x-on:click="forwardToLm(village)" class="btn btn-sm btn-info no-wrap">Verify & Forward to <?= LM_LABEL ?> <i class="fa fa-chevron-right"></i></button>
                        ...
                        <tbody>
                            <template x-for="(list,index) in view_map_lists_village.map_lists">
                                <tr>
                                    <td x-text="index + 1"></td>
                                    <td>
                                        <a x-bind:href="'<?= base_url() ?>index.php/nc_village/NcVillageCoController/viewUploadedMap?id=' + list.id" class="btn btn-info py-2" style="color: white" target="_blank">
                                            View Map
                                        </a>
                                    </td>
                                </tr>
