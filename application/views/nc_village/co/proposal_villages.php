    ...
    function alpineData() {
        return {
            ...
            init() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/getProposalVillages',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: data,
            ...
            signProposal() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/saveProposalPdf',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: data,
                    success: function(data) {
                        if (data) {
                            ...
                            if (data != null || data != '') {
                                ...
                                self.loadPreviewForSign('<?= base_url() ?>index.php/nc_village/NcVillageCoController/getProposalBase');
            ...
            storeSignedProposal(jsonData, sign_key) {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/storeSignedProposal',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            sendProposalBypassSign() {
                var self = this;

                $('#loader2').removeClass('invisible');

                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/storeProposalBypassSign',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    success: function(data) {
                            ...
                            <tbody>
                                ...
                                <template x-for="(village,index) in villages" :key="index">
                                    <tr x-show="request_type == '' ||
                                        ...
                                        <td x-text="village.sk_verified_at ? (new Date(village.sk_verified_at)).toLocaleString('en-IN', { dateStyle: 'medium', timeStyle: 'short' }) : ''"></td>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info text-white no-wrap" x-bind:href=base_url+"index.php/nc_village/NcVillageCoController/showDags?application_no="+village.application_no target=" _blank">View <i class=" fa fa-eye"></i></a>
                                        </td>
                                    </tr>
                                </template>
