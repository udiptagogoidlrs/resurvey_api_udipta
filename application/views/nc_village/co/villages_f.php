    ...
    function alpineData() {
        return {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/getVillagesF',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <select x-model="filter_status" id="filter_status" class="form-control form-control-sm">
                        ...
                        <option value="co_verified">Verified</option>
                        <option value="co_reverted">Reverted</option>
                    </select>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <template x-for="(village,index) in villages">
                                    <tr>
                                        ...
                                        <td class="no-wrap" x-text="village.sk_verified_at ? (new Date(village.sk_verified_at)).toLocaleString('en-IN', { dateStyle: 'medium', timeStyle: 'short' }) : 'N/A'"></td>
                                        <td x-text="village.sk_note"></td>
                                        <td x-text="village.co_note"></td>
                                        <td>
                                            <b>
                                                <small class="text-warning" x-show="village.status == 'T'">Pending Ceritification</small>
                                                <small class="text-success" x-show="village.status == 'G'">Certified</small>
                                            </b>
                                        </td>
                                        <td>
