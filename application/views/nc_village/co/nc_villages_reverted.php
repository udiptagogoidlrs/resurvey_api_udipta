	...
	function alpineData() {
		return {
			...
			getVillages() {
				...
				$.ajax({
					url: '<?= base_url(); ?>index.php/nc_village/NcVillageCoController/getVillagesH',
					method: "POST",
					async: true,
					dataType: 'json',
			...
			<table class="table table-hover table-sm">
				...
				<template x-for="(village,index) in villages">
					<tr>
						...
						<td>
							<a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village/NcVillageCoController/showDags?application_no="+village.application_no>Proceed <i class=" fa fa-chevron-right"></i></a>
						</td>
					</tr>
				</template>
