        ...
        <form class='form-horizontal mt-3' id="f1" method="post" action="" enctype="multipart/form-data">
            <div class="row bg-light p-0 border border-dark">
                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                if ($nonCropList) {
                                    foreach ($nonCropList as $row) {
                                        $tid = $row->noncrop_use_id;
                                        $dagno = $row->dag_no;
                                        $dcode = $row->dist_code;
                                ...
                                ?>
                                        ...
                                        <tr>
                                            <td><?php echo $row->noncrop_use_id; ?></td>
                                            <td style="font-size:14px"><?php echo $row->yn; ?></td>
                                            <td><?php echo $row->noncrop_type; ?></td>
                                            <td>
                                                <a href="<?php echo base_url('index.php/Chithacontrol/nonCropModify/' . $nm); ?>" class="btn btn-info ">Edit</a>
                                            </td>
                                        </tr>
                ...
                <div class="col-12 text-center pb-3">
                    ...
                    <a href="<?php echo base_url('index.php/Chithacontrol/noncrop/'); ?>" class="btn btn-primary">Add Non agricultural</a>
