    ...
    function alpineData() {
        return {
            ...
            portVill(village) {
                ...
                $.confirm({
                    title: 'Confirm',
                    content: 'Please Confirm To Port Chitha Data from Dharitree to ' + village.vill_townprt_code,
                    type: 'orange',
                    typeAnimated: true,
                    buttons: {
                        Ok: {
                            ...
                            action: function() {
                                ...
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/utility/PortDharDataController/portDataFromDharitree',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: data,
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/utility/PortDharDataController/villagedetails',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: data,
...
<div class="col-lg-12 col-md-12" x-data="alpineData()">
    <div class="text-center p-2 mb-2 bg-info" style="font-size:18px; font-weight: bold;">Port Chitha Data From Dharitree</div>
    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3">
                            ...
                            <select x-model="dist_code_from" id="district_from" class="form-control form-control-sm">
                                ...
                                <?php foreach ($districts as $district) : ?>
                                    <option value="<?= $district['dist_code'] ?>"><?php echo ($district['dist_code'] . ' - ' . $district['loc_name']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-lg-3 col-md-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                <div>
                                    <h5> Port Chitha Data From Dharitree
                                    ...
                                    <tbody>
                                        ...
                                        <template x-for="(village,index) in villages">
                                            <tr x-bind:class="village.is_alpha > 0 ? 'bg-warning' : ''">
                                                ...
                                                <td x-text="village.loc_name+ '-'+village.vill_townprt_code"></td>
                                                <td>
                                                ...
                                                <td>
                                                    <button x-show="!is_loading_port" x-on:click="portVill(village)" class="btn btn-sm btn-success" type="button">Port</button>
                                                    <div x-show="is_loading_port && loading_uuid==village.uuid" class="spinner-border text-primary" role="status">
                                                        <span class="sr-only">Loading...</span>
                                                    </div>
                                                    <a target="_blank" x-bind:href=base_url+"index.php/nc_village/NcVillagePortingController/villageLog/"+village.dist_code+"-"+village.subdiv_code+"-"+village.cir_code+"-"+village.mouza_pargona_code+"-"+village.lot_no+"-"+village.vill_townprt_code>Log</a>
                                                </td>
                                            </tr>
                                        </template>
