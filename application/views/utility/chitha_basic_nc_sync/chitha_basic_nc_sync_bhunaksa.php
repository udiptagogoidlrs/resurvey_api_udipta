    ...
    function alpineData() {
        return {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/utility/ChithaBasicNcSyncController/villages_bhunaksa_sync',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
...
<div class="col-lg-12 col-md-12" x-data="alpineData()">
    <div class="text-center p-2 mb-2 bg-success" style="font-size:18px; font-weight: bold;">Sync chitha_basic_nc with Bhunaksa</div>
                        ...
                        <tbody>
                            ...
                            <template x-for="(village,index) in villages">
                                <tr x-bind:class="(village.is_nc_village_exists &&  village.is_nc_village_exists.dc_chitha_sign == 'Y') ? '' : ''">
                                    ...
                                    <td>
                                        <a target="_blank" class="btn btn-info btn-sm" x-show="village.is_nc_village_exists" x-bind:href=base_url+"index.php/sync-bhunaksa-village/"+village.dist_code+"_"+village.subdiv_code+"_"+village.cir_code+"_"+village.mouza_pargona_code+"_"+village.lot_no+"_"+village.vill_townprt_code+"_"+village.uuid>View Dags</a>
                                    </td>
                                </tr>
                            </template>
