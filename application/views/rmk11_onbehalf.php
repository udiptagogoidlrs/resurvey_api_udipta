    ...
    <div class="container bg-light p-0 border border-dark mt-5 mb-5">
      <div class="col-12 px-0 pb-3">
        <div class="bg-info text-white text-center py-2">
          <h3>On Behalf of Details(Column 31)</h3>
        </div> 
      </div>

      <?php echo form_open('Remark/remarkForm__on_behalf_of_submit'); ?>
      <div class="row">

        <div class="col-sm-6">
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-5 col-form-label">On Behalf of ID:</label>


            <div class="col-sm-7">
              <input type="text" class="form-control" id="inputEmail3" name="onbehalf_id">
            </div>
          ...
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-5 col-form-label">On Behalf of Name:<font color=red>*</font></label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="inputEmail3" name="onbehalf_name" >
            </div>
          </div>
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-5 col-form-label">On Behalf of Gurdian Name:</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="inputEmail3" name="onbehalf_guardian" >
            </div>
          </div>
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-5 col-form-label">Relation With Guardian:</label>
            <div class="col-sm-7">
              <select name="onbehalf_rel_gur" class="form-control">
          ...
          <div class="col-12 text-center pb-3">
            ...
            <input type="button" class="btn btn-primary" id="psubmit" name="psubmit" value="Submit" onclick="onbehalfofentry();"></input>
            <input type="button" class="btn btn-primary pull-right" id="psubmit" name="psubmit" value="Next" onclick="onbehalfofentrySkip();"></input>
