<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" style="background-color: transparent !important;" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('index.php/verification/ADCController/index') ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Chitha Verification</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('index.php/verification/ADCController/viewSignedPdf') ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>View Signed PDF</p>
                            </a>
                        </li>
                        <?php if (ENABLE_VERIFICATION_CERT == '1'): ?>
                            <li class="nav-item">
                                <a href="<?= base_url('index.php/verification/ADCController/verificationCertificate') ?>" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
