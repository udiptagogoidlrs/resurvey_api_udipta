    ...
    <div class="container bg-light p-0 border border-dark mt-5 mb-5">
      <div class="col-12 px-0 pb-3">
        <div class="bg-info text-white text-center py-2">
          <h3>Along with Details(Column 31)</h3>
        </div> 
      </div>

      <?php echo form_open('Remark/remarkForm_along_with_submit'); ?>
      <div class="row">

        <div class="col-sm-6">
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-5 col-form-label">Along With ID:</label>


            <div class="col-sm-7">
              <input type="text" class="form-control" id="inputEmail3" name="alongwith_id">
            </div>
          </div>
<div class="form-group row">
          ...
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-5 col-form-label">Along With Name:<font color=red>*</font></label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="inputEmail3" name="alongwith_name" >
            </div>
          </div>
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-5 col-form-label">Along With Gurdian Name:</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" id="inputEmail3" name="alongwith_guardian" >
            </div>
          </div>
          <div class="form-group row">
            <label for="inputPassword3" class="col-sm-5 col-form-label">Relation With Guardian:</label>
            <div class="col-sm-7">
              <select name="alongwith_rel_gur" class="form-control">
          ...
          <div class="col-12 text-center pb-3">
            ...
            <input type="button" class="btn btn-primary" id="psubmit" name="psubmit" value="Submit" onclick="alongwithentry();"></input>
            <input type="button" class="btn btn-primary pull-right" id="psubmit" name="psubmit" value="Next" onclick="alongwithentrySkip();"></input>
