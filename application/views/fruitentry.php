      ...
      <div class="row bg-light p-0 border border-dark">
        <div class="col-12 px-0 pb-3">
          <div class="bg-info text-white text-center py-2">
            <h3>Entry of Fruit details(Col 30)</h3>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="table-responsive">
            <table class="table" border=0>
              ...
              <tr>
                ...
                <td><input type="text" value="<?php echo $fruitId; ?>" class="form-control-sm" id="frplantid" name="frplantid"></td>
              </tr>
              <tr>
                ...
                <td>
                  <select class="form-control" name="frname" id="frname">
                    ...
                    <?php foreach ($fruitnm as $row) { ?>
                      <option value="<?php echo $row->fruit_code; ?>" <?php if ($row->fruit_code == $fruitnm1) { ?> selected <?php } ?>>
                        <?php echo $row->fruit_name; ?></option>
                    <?php } ?>
                  </select>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td><input type="text" class="form-control-sm" id="fplantno" name="fplantno"></td>
              </tr>
            </table>
          </div>
        </div>
        ...
        <div class="col-12 text-center pb-3">
          ...
          <input type='button' class="btn btn-primary" id="frsubmit" name="frsubmit" value="Submit" onclick="fruitentry();"></input>
