    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card" id="loc_save">
                <div class="card-body">
                    <?php echo form_open('import_vlb/ImportVlbController/importVlb', ['enctype' => "multipart/form-data"]); ?>
                    <div class="col-12 px-0 pb-3">
                        <div class="bg-warning text-white text-center py-1">
                            <h5>Select VIllage to Import Village Land Bank Data</h5>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="xl">Select CSV File the Village:</label>
                        <input type="file" accept=".csv" name="csv" class="form-control form-control-sm">
                    </div>
