            ...
            <div class="card-body">
                <form class="form-horizontal unicode" name="form" method='post' action="<?php echo $base ?>index.php/get-jamabandi-details-report">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <label><u>Upload Documents <span style="color: red;font-weight: bold;">(pdf format not more than 2 MB)</span></u></label>
                            &nbsp;
                ...
                2. Uploaded file size should not be more than 4MB"></i>
                            ...
                            <table class="table table-striped table-bordered">
                                <tbody id='certi_tab'>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type='file' name="doc1_file" id="doc1_file" required></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <?php if (!empty($doc2_id)) {
                                                if ($doc2_id->doc_flag != '' || $doc2_id->doc_flag != null) { ?>
                                                    <div id="div_noc">
                                                        <button class="btn btn-sm btn-info" type="button"><a style="color: red; text-decoration: none;" href='<?php echo base_url() ?>index.php/Chithacontrol/downloadDocuments?doc_flag=<?php echo $doc2_id->doc_flag ?>&uuid=<?php echo $doc2_id->uuid ?>&dag_no=<?php echo $doc2_id->dag_no ?>' target="_blank">VIEW <?= $doc2_id->file_name ?></a></button>&nbsp;&nbsp;
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning uploadOMutDocumentCO" id='3'>Upload &nbsp;<i class='fa fa-upload'></i></button>
                                            </a>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($doc3_id)) {
                                                if ($doc3_id->doc_flag != '' || $doc3_id->doc_flag != null) { ?>
                                                    <div id="div_kha">
                                                        <button class="btn btn-sm btn-info" type="button"><a style="color: red; text-decoration: none;" href='<?php echo base_url() ?>index.php/Chithacontrol/downloadDocuments?doc_flag=<?php echo $doc3_id->doc_flag ?>&uuid=<?php echo $doc3_id->uuid ?>&dag_no=<?php echo $doc3_id->dag_no ?>' target="_blank">VIEW <?= $doc3_id->file_name ?></a></button>&nbsp;&nbsp;
                                                        <button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO removeNOC" id='3'>Remove&nbsp;<i class='fa fa-minus-square'></i></button>
                                                    </div>
                                            <?php }
                                            } ?>
                                            <div id="file_3"></div>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type='file' name="doc4_file" id="doc4_file"></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning uploadOMutDocumentCO" id='4'>Upload &nbsp;<i class='fa fa-upload'></i></button>
                                            </a>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($doc4_id)) {
                                                if ($doc4_id->doc_flag != '' || $doc4_id->doc_flag != null) { ?>
                                                    <div id="div_touzi">
                                                        <button class="btn btn-sm btn-info" type="button"><a style="color: red; text-decoration: none;" href='<?php echo base_url() ?>index.php/Chithacontrol/downloadDocuments?doc_flag=<?php echo $doc4_id->doc_flag ?>&uuid=<?php echo $doc4_id->uuid ?>&dag_no=<?php echo $doc4_id->dag_no ?>' target="_blank">VIEW <?= $doc4_id->file_name ?></a></button>&nbsp;&nbsp;
                                                        <button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO removeNOC" id='4'>Remove&nbsp;<i class='fa fa-minus-square'></i></button>
                                                    </div>
                                            <?php }
                                            } ?>
                                            <div id="file_4"></div>
                            ...
                            <table class="table table-striped table-bordered">
                                <tbody id=''><span style="color: black;font-weight: bold;">Additional Document (if Any)</span>
                                    <tr>
                                        ...
                                        <td><input type='file' name="doc5_file" id="doc5_file"></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning uploadOMutDocumentCO" id='5'>Upload &nbsp;<i class='fa fa-upload'></i></button>
                                            </a>
                                        </td>
                                        <td>
                                            ...
                                            <?php if (!empty($doc5_id)) {
                                                if ($doc5_id->doc_flag != '' || $doc5_id->doc_flag != null) { ?>
                                                    <div id="div_addi">
                                                        <button class="btn btn-sm btn-info" type="button"><a style="color: red; text-decoration: none;" href='<?php echo base_url() ?>index.php/Chithacontrol/downloadDocuments?doc_flag=<?php echo $doc5_id->doc_flag ?>&uuid=<?php echo $doc5_id->uuid ?>&dag_no=<?php echo $doc5_id->dag_no ?>' target="_blank">VIEW <?= $doc5_id->file_name ?></a></button>&nbsp;&nbsp;
                                                        <button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO removeNOC" id='5'>Remove&nbsp;<i class='fa fa-minus-square'></i></button>
                                                    </div>
                                            <?php }
                                            } ?>
                                            <div id="file_5"></div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                            <br>
                            <a href="<?php echo base_url(); ?>index.php/upload_document" class="btn btn-danger">
                                <i class="fa fa-arrow-left"></i>&nbsp; BACK TO DOCUMENT UPLOAD MENU
                            </a>
    ...
    $('.uploadOMutDocumentCO').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.flag_set == '1') {
                    $('#div_death').html('');
                    $('#file_1').html('<a class="btn btn-sm btn-info" type="button" style="color: red; text-decoration: none;" href="' + baseurl + 'index.php/Chithacontrol/downloadDocuments?doc_flag=' + data.doc_flag + '&dag_no=' + data.dag_no + '&uuid=' + data.uuid + '" target="_blank">VIEW ' + data.filename + '</a>' + ' ' + '<button type="button" class="btn btn-sm btn-danger removeOMutReportDocumentCO" id="1">Remove&nbsp;<i class="fa fa-minus-square"></i></button>');
                }
                if (data.flag_set == '2') {
                    $('#div_noc').html('');
