        ...
        <div class="col-lg-8">
            <div class="card card-info">
                <div class="card-header bg-success text-white">
                    <h3 class="card-title text-center font-weight-bold">View Patta</h3>
                </div>
                <div class="card-body">
                    <?php echo form_open(base_url('index.php/PattaController/viewPatta')); ?>
...
<script src="<?= base_url('assets/js/view_patta.js') ?>"></script>