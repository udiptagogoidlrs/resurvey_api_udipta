            ...
            <tbody id="view-section-body">
                <?php foreach($verified_dags as $verified_dag): ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary" href="<?php echo base_url('index.php/verification/SKController/getSignedPdf?param=' . $verified_dag->param); ?>" target="_blank">View</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<script>
    ...
    $(document).on('change', '#vill_townprt_code', (e)=>{
        ...
        if(e.currentTarget.value != '' && e.currentTarget.value != undefined) {
            $.ajax({
                url: baseurl + 'index.php/verification/SKController/viewSignedPdf',
                method: 'POST',
                    ...
                    if(verified_dags.length > 0) {
                        ...
                        verified_dags.forEach(element => {
                            ...
                            var segment5 = `</div>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="${baseurl}index.php/verification/SKController/getSignedPdf?param=${element.param}" target="_blank">View</a>
                                </td>
                            </tr>`;
