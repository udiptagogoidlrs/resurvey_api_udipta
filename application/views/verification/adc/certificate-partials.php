...
<div style="padding:24px;">
    <h3 style="text-align: center;">Annexure-IV</h3>
    <h5 style="text-align: center;font-size: 14px;"><u>Validation certificate by ADC(Rev) for CLR Data Entry</u></h5>
    <div style="margin-top: 24px;text-align:right;">
        <p style="font-size: 14px;">Date of Generation : <?php echo date('d-m-Y'); ?></p>
    </div>
    <div>
        <p style="font-size: 14px;">Name of the ADC(Rev) : <?php echo $adc_name; ?></p>
    ...
    <div style="margin-top: 32px;">
        <p>
            Certified that I have tallied and verified 50 % of the dags duly validated and certified by
            the Circle Officer/ASO in online chitha data entry module, with the manual Chitha and
            found correct.
        </p>
    </div>
    <div style="margin-top: 32px;text-align:right;">
        <!-- <p><b>Signature of ADC(Rev)</b></p> -->
    </div>
</div>