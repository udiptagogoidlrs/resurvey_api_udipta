...
<script>
    ...
    $(document).on('change', '#vill_townprt_code', (e)=>{
        ...
        if(e.currentTarget.value != '' && e.currentTarget.value != undefined) {
            $.ajax({
                url: baseurl + 'index.php/verification/COController/viewSignedPdf',
                method: 'POST',
                    ...
                    if(verified_dags.length > 0) {
                        ...
                        verified_dags.forEach(element => {
                            ...
                            var segment5 = `</div>
                                ...
                                <td>
                                    <a class="btn btn-primary" href="${baseurl}index.php/verification/COController/getSignedPdf?param=${element.param}" target="_blank">View</a>
                                </td>
                            </tr>`;
