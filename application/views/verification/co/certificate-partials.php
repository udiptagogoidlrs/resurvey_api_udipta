...
<div style="padding:24px;">
        <h3 style="text-align: center;">Annexure-III</h3>
        <h5 style="text-align: center;font-size: 14px;"><u>Validation Certificate by Circle Officer/ASO for CLR-Chitha data entry</u></h5>
        <div style="margin-top: 24px;text-align:right;">
            <p style="font-size: 14px;">Date of Generation : <?php echo date('d-m-Y'); ?></p>
        </div>
        <div>
            <p style="font-size: 14px;">Name of the Circle Officer/ASO : <?php echo $co_name ?></p>
            <p style="font-size: 14px;">Cirlce Office / ASO : <?php echo $circle_name ?></p>
        ...
        <div style="margin-top: 32px;">
            <p>
                Certified that I have tallied and verified 25 % of the dags duly validated and certified by
                the LRS in online chitha data entry module, with the manual Chitha and found correct.
            </p>
        </div>
        <div style="margin-top: 32px;text-align:right;">
            <!-- <p><b>Signature of Circle Officer/ASO</b></p> -->
        </div>
    </div>