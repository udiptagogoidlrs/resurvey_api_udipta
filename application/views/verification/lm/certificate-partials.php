...
<div style="padding:24px;">
    <h3 style="text-align: center;">Annexure-I</h3>
    <h5 style="text-align: center;font-size: 14px;"><u>Validation Certificate by Land Record Assistant for CLR-Chitha data entry</u></h5>
    <div style="margin-top: 24px;text-align:right;">
        <p style="font-size: 14px;">Date of Generation : <?php echo date('d-m-Y') ?></p>
    </div>
    <div>
        <p style="font-size: 14px;">Name of the LRA : <?php echo $lm_name; ?></p>
    ...
    <div style="margin-top: 32px;">
        <p>
            Certified that I have tallied the online chitha data entry in the module with the manual
            Chitha and validate all the dag entries and found correct.
        </p>
    </div>
    <div style="margin-top: 32px;text-align:right;">
        <!-- <p><b>Signature of LRA</b></p> -->
    </div>
</div>