...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card rounded-0">
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><b><?php echo($this->lang->line('dag_area')) ?> -</b>&nbsp;<b>বিঘা:</b> <?= $record[0]->dag_area_b ?>,&nbsp;<b><?php echo($this->lang->line('katha')) ?>:</b> <?= $record[0]->dag_area_k ?>,&nbsp;<b><?php echo($this->lang->line('lesa')) ?>:</b> <?= $record[0]->dag_area_lc ?>,&nbsp;<b>গন্ডা:</b> <?= $record[0]->dag_area_g ?></td>
                        ...
                        <tbody>
                            ...
                            foreach ($pattadars as $pattadar) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">বিঘা-<?= $pattadar->dag_por_b ?>, <?php echo($this->lang->line('katha')) ?>-<?= $pattadar->dag_por_k ?>, <?php echo($this->lang->line('lesa')) ?>-<?= $pattadar->dag_por_lc ?>, গন্ডা-<?= $pattadar->dag_por_g ?> </td>
        ...
        <div class="card-footer">
            <a href="<?= base_url('index.php/verification/LMVerificationController/index') ?>">
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" value="1" name="pattadar_flag" disabled>Yes&nbsp;&nbsp;
                                            </label>
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" value="0" name="pattadar_flag" disabled>No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" value="m" name="pattadar_gender" disabled>Male&nbsp;&nbsp;
                                            </label>
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" value="f" name="pattadar_gender" disabled>Female&nbsp;&nbsp;
                                            </label>
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" value="o" name="pattadar_gender" disabled>Others
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php if (!$is_govt) : ?>
                                ...
                                <div class="form-group row">
                                    <label for="edit_pdar_add2" class="col-sm-3 col-form-label">Address 1:</label>
                                    <div class="col-sm-9">
...
<div class="modal fade" id="verifyModal" tabindex="-1" role="dialog" aria-labelledby="verifyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifyModalLabel">Verify Dag</h5>
                        ...
                        <div class="icon-box">
                            <div class="icon-box-content table-cell">
                                <div class="icon-box-content" style="padding-top: 10px;">
                                    <p class="text-center text-bold"><button class="btn btn-primary" id="btn-esign">Verify Using Aadhaar</button></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $('#viewModal').on('show.bs.modal', function(e) {
        ...
        if (govtPattaCodes.indexOf(patta_type_code) === -1) {
            ...
            $("input[name=pattadar_gender][value=" + e.relatedTarget.pdar_gender + "]").prop('checked', true);

            // Set radio buttons for p_flag
            $("input[name=pattadar_flag][value=" + e.relatedTarget.p_flag + "]").prop('checked', true);
        }
    });
    ...
    $(document).on('click', '#btn-esign', (e) => {
        ...
        $.ajax({
            url: baseurl + 'index.php/verification/LMController/getBaseSFile',
            data: {
                dist_code:dist_code, 
                subdiv_code:subdiv_code, 
                cir_code:cir_code, 
