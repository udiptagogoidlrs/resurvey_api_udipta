...
<div class="container mx-5">
    <div class="text-right">
        ...
        <button class="btn btn-warning esignInit" title="E-Sign" data-success="<?= $is_final_cert_ready_to_esign['success'] ? 1 : 0; ?>" data-message="<?= $is_final_cert_ready_to_esign['message']; ?>">
...
<div class="container-fluid px-5 mx-5 py-5 mt-3 mb-5 bg-white printable-div" id="printableDiv">
    <?php 
        if(!$chitha_verification_certificate):
            include APPPATH . '/views/verification/dc/certificate-final-partials.php';
...
<script>
    ...
    $(document).on('click', '#btn-esign', (e) => {
        ...
        $.ajax({
            url: '<?= base_url('index.php/verification/DCController/eSignInitFinalCert') ?>',
            data: {
                // dist_code:dist_code, 
