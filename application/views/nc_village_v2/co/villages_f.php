    ...
    function alpineData() {
        return {
            ...
            init() {
				...
				this.villages = <?= json_encode($villages) ?>;
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village_v2/NcVillageCoController/getVillagesF',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
                        ...
                        <tbody>
                            ...
                            <template x-for="(village,index) in villages">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village_v2/NcVillageCoController/showDags?application_no="+village.application_no>Proceed <i class=" fa fa-chevron-right"></i></a>
                                    </td>
                                </tr>
                            </template>
