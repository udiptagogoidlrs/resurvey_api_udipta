    ...
    function alpineData() {
        return {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village_v2/NcVillageSkController/getVillagesS',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
                        ...
                        <tbody>
                            ...
                            <template x-for="(village,index) in villages">
                                <tr>
                                    ...
                                    <td>
                                        <b>
                                            <small class="text-warning" x-show="village.status == 'S'">Pending Verification</small>
                                            <small class="text-success" x-show="village.status == 'T'">Verified</small>
                                        </b>
                                    </td> -->
                                    <td>
                                        <a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village_v2/NcVillageSkController/showDags?application_no="+village.application_no>Proceed <i class=" fa fa-chevron-right"></i></a>
                                    </td>
                                </tr>
                            </template>
