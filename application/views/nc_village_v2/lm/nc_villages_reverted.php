    ...
    function alpineData() {
        return {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village_v2/NcVillageLmController/getVillagesH',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                ...
                <tbody>
                    ...
                    <template x-for="(village,index) in villages">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village_v2/NcVillageLmController/ncVillages/"+village.vill_townprt_code+"/"+village.uuid+"/0">Proceed <i class=" fa fa-chevron-right"></i></a>
                            </td>
                        </tr>
                    </template>
