	...
	function alpineData() {
		return {
			...
			getVillages() {
				...
				$.ajax({
					url: '<?= base_url(); ?>index.php/nc_village_v2/NcVillageDcController/getVillagesH',
					method: "POST",
					async: true,
					dataType: 'json',
			...
			<table class="table table-hover table-sm">
				...
				<template x-for="(village,index) in villages">
					<tr>
						...
						<td>
							<span x-show="village.dlr_note" x-text="'DLR Note: '+village.dlr_note"></span><br>
							<span x-show="village.adlr_note" x-text="'ADLR Note: '+village.adlr_note"></span>
						</td>
						<td>
							<a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village_v2/NcVillageDcController/showDags/0?application_no="+village.application_no>Proceed <i class=" fa fa-chevron-right"></i></a>
						</td>
					</tr>
				</template>
