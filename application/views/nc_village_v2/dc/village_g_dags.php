                                                ...
                                                <tbody>
                                                    <template x-for="(list,index) in map_list" :key="list.id">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a :href="'<?= base_url() ?>index.php/nc_village_v2/NcVillageDcController/viewUploadedMap?id=' + list.id"
                                                ...
                                                <tbody>
                                                    <template x-for="(omap, idx) in old_maps" :key="omap.id">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a :href="'<?= base_url() ?>index.php/nc_village_v2/NcVillageDcController/viewUploadedMap?id=' + omap.id"
