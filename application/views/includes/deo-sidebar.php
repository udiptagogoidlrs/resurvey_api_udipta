    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?php echo(in_array(current_url(), [base_url('index.php/Chithacontrol/index'),base_url('index.php/ChithaDagEditController/location'),base_url('index.php/ChithaDagEditController/dagDetails'),base_url('index.php/Chithacontrol/dagbasic'),base_url('index.php/ChithaDagEditController/viewPattadars')]) ? 'menu-open' : '') ?>">
					...
					<?php if(($this->session->userdata('dist_code') == '21') || ($this->session->userdata('dist_code') == '22') || ($this->session->userdata('dist_code') == '23')) { ?>
                        <li class="nav-item">
                            <a href="<?= base_url('index.php/Chithacontrol/index') ?>" class="nav-link <?php echo(in_array(current_url(), [base_url('index.php/Chithacontrol/index'),base_url('index.php/Chithacontrol/dagbasic')]) ? 'active' : '') ?>">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('index.php/JamaPattadarController/locationForm') ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Jamapattadar Update </p>
                            </a>
                        </li>
                    </ul>
                </li>
