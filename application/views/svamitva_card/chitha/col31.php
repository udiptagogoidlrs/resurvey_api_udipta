<td valign="top" height="409" width="15%" rowspan=3 id=chitha_col_31><!--REMARKS-->
    ...
    ?>
            <p><?php //echo  $headingsro.'&nbsp;'.'&nbsp;' . $newDatesro . 'তাৰিখে' . '&nbsp;'.'&nbsp;'.'Deed No.'.'&nbsp;' . $chithainf['sro'][$key]['deed_no'] . 'নং দলিল যোগে' . '&nbsp;'.'&nbsp;' . $chithainf['sro'][$key]['reg_from_name'] .'&nbsp;'. 'পৰা' . '&nbsp;' . $chithainf['sro'][$key]['reg_to_name'] . 'ৰ নামত' . '(B' . $chithainf['sro'][$key]['dag_area_b'] . '- K' . $chithainf['sro'][$key]['dag_area_k'] . '- L' . $chithainf['sro'][$key]['dag_area_lc'] . ')' . 'মাটি' . '&nbsp;' . 'হস্তান্তৰ ' . '&nbsp;' . 'হয়.'               
                ?></p>
        ...
        <?php foreach ($remark as $r) : ?>
            ...
            <?php if (sizeof($r) > 0) : ?>
                ...
                <?php if ($r['ord_type_code'] == '01') : ?>
                    ...
                    <p><?php echo $r['ord_passby_desig']; ?>ৰ </p>
                    <p>
    ...
    ?>
            <p>
                ...
                ?>
                    ...
                    <?= 'উচ্ছেদিত তাং:'; ?>
                    <br>
                    <?= date("d-m-Y", strtotime($chithainf['encro'][$key]['encro_evic_date'])); ?>
                <?php endif; ?>
            </p>
    <?php
        endforeach;
