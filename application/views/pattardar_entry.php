    ...
    <div class="container p-0 border">
        ...
        <form class='form-horizontal mt-3' id="f1" method="post" action="" enctype="multipart/form-data">
                    ...
                    <?php if (!$is_govt) : ?>
                        ...
                        <?php if ($this->session->userdata('dist_code') == '21') { ?>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="dag_por_b" placeholder="Dag Portion Bigha" name="dag_por_b" value="0">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-3 col-form-label">Dag Portion Katha:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="dag_por_k" placeholder="Dag Portion Katha" name="dag_por_k" value="0">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">Dag Portion Chatak:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="dag_por_lc" placeholder="Dag Portion Chatak" name="dag_por_lc" value="0">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <?php } else { ?>
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label">Dag Portion Lessa:</label>
                                <div class="col-sm-9">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check-inline">
                                    ...
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" checked value="0" name="p_flag">No
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" checked value="m" name="p_gender">Male&nbsp;&nbsp;
                                    </label>
                                    <label class="form-check-label">
            ...
            <div class="col-12 text-center pb-3">
                ...
                <input type="button" class="btn btn-primary" id="psubmit" name="psubmit" value="Submit" onclick="pdarentry(<?php echo ($is_govt) ?>);"></input>
                <?php if ($pattaderId > 1) { ?>
