...
<div class="container">
    <div class="card col-md-10" id="loc_save">
        <div class="card-body">
            <form class="form-horizontal unicode" name="form" method='post' action="<?php echo $base?>index.php/set-patta-no-for-jamabandi">

                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h4 class="mb-4" style="line-height: 0.2; color: #007bff; margin-top: 20px" >
                            Select Patta Details For Jamabandi Update
                        </h4>
                    </div>
                </div>
...
<script>
    $('#pattaNumber').on('change', function()
    {
        ...
        $.ajax({
            url: baseurl + 'index.php/get-patta-type-jamabandi',
            type: 'POST',
            data: data,
            error: function()
            {
