    ...
    <div class="container">
        ...
        <div class="card col-md-12" id="loc_save">
            <div class="card-body">
                ...
                <form action="<?php echo $base ?>index.php/get-patta-details-for-jamabandi-report" method="post" enctype="multipart/form-data">

                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h4 class="mb-4" style="line-height: 0.2; color: #007bff; margin-top: 20px">
                                Select Location For Jamabandi Report
                            </h4>
                        </div>
                    </div>
