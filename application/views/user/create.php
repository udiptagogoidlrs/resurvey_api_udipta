    ...
    <div class="row">
        <div class="col-lg-12 ">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    <?php echo form_open(base_url('index.php/UserManagement/storeUser')); ?>
                    <h4>Basic Details</h4>
                    <div class="border border-dark p-4">
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-4">
                                <input value="<?php echo(isset($_POST['name']) ? $_POST['name'] : '') ?>" type="text" class="form-control" placeholder="Please enter name" name="name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control role_type" id="role_type" name="role_type">
                                    ...
                                    <?php foreach ($privileges as $priv) : ?>
                                        <?php if (in_array(trim($priv->priv_code), ['adm', 'mut'])) : ?>
                                            <option <?php echo((isset($_POST['role_type']) && $_POST['role_type'] == trim($priv->priv_code)) ? 'selected="selected"' : '') ?> value="<?php echo trim($priv->priv_code); ?>"><?php echo $priv->priv_desc; ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-2 rasid">
                                <input type="radio" name="status" id="inlineRadio2" class="col-form-label" value="E" checked> Enable
                            </label>
                            <label class="col-sm-2 rasid">
                                <input type="radio" name="status" id="inlineRadio3" class="col-form-label" value="D"> Disable
                            </label>
                            ...
                            <div class="col-sm-4">
                                <select class="form-control role" name="role" id="role">
                                    ...
                                    <?php foreach ($roles as $role) : ?>
                                            <option <?php echo((isset($_POST['role']) && $_POST['role'] == trim($role['user_desig_code'])) ? 'selected="selected"' : '') ?> value="<?php echo trim($role['user_desig_code']); ?>"><?php echo $role['user_desig_as']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" value="<?php echo(isset($_POST['phone_no']) ? $_POST['phone_no'] : '') ?>" maxlength="10" minlength="10" class="form-control" name="phone_no">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="date" value="<?php echo(isset($_POST['date_of_joining']) ? $_POST['date_of_joining'] : '') ?>" class="form-control " name="date_of_joining">
                    ...
                    <div class="border border-dark p-4">
                        <div class="form-group row">
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" id="dist_code" name="dist_code">
                                    <option value="">-- Select --</option>
                                    <?php foreach ($districts as $district) : ?>
                                        <option <?php echo((isset($_POST['dist_code']) && $_POST['dist_code'] == $district['dist_code']) ? 'selected="selected"' : '') ?> value="<?php echo $district['dist_code']; ?>"><?php echo $district['loc_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" id="subdiv_code" name="subdiv_code">
                                    <option value="">--Select--</option>
                                    <?php foreach ($subdivs as $subdiv) : ?>
                                        <option <?php echo((isset($_POST['subdiv_code']) && $_POST['subdiv_code'] == $subdiv['subdiv_code']) ? 'selected="selected"' : '') ?> value="<?php echo $subdiv['subdiv_code']; ?>"><?php echo $subdiv['loc_name']; ?></option>
                                    <?php endforeach; ?>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" id="circle_code" name="circle_code">
                                    <option value='' selected>--Select--</option>
                                    <?php foreach ($circles as $circle) : ?>
                                        <option <?php echo((isset($_POST['circle_code']) && $_POST['circle_code'] == $circle['cir_code']) ? 'selected="selected"' : '') ?> value="<?php echo $circle['cir_code']; ?>"><?php echo $circle['loc_name']; ?></option>
                                    <?php endforeach; ?>
                        ...
                        <div class="form-group row" id="lm_only_location" <?php echo((isset($_POST['role']) && $_POST['role'] == 'LM') ? '' : 'style="display: none;"') ?> >
                            <div class="col-sm-4">
                                <label for="" class="col-form-label">Mouza/Porgona</label>
                                <select class="form-control" id="mouza_pargona_code" name="mouza_pargona_code">
                                    <option value='' selected>--Select--</option>
                                    <?php foreach ($mouzas as $mouza) : ?>
                                        <option <?php echo((isset($_POST['mouza_pargona_code']) && $_POST['mouza_pargona_code'] == $mouza['mouza_pargona_code']) ? 'selected="selected"' : '') ?> value="<?php echo $mouza['mouza_pargona_code']; ?>"><?php echo $mouza['loc_name']; ?></option>
                                    <?php endforeach; ?>
                            ...
                            <div class="col-sm-4">
                                ...
                                <select class="form-control" id="lot_no" name="lot_no">
                                    ...
                                    <?php foreach ($lots as $lot) : ?>
                                        <option <?php echo((isset($_POST['lot_no']) && $_POST['lot_no'] == $lot['lot_no']) ? 'selected="selected"' : '') ?> value="<?php echo $lot['lot_no']; ?>"><?php echo $lot['loc_name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <?php echo form_error('lot_no', '<span class="text-danger">', '</span>'); ?>
                            </div>
                        </div>
                        <div class="form-group row" id="sk_input" <?php echo((isset($_POST['role']) && $_POST['role'] == 'LM') ? '' : 'style="display: none;"') ?>>
                            <div class="col-sm-4">
                                <label for="" class="control-label">SK</label>
                                <select class="form-control" id="sk" name="sk_name">
                                    <option value='' disabled selected>Select SK</option>
                                    <?php foreach ($sks as $sk) : ?>
                                        <option <?php echo((isset($_POST['sk_name']) && $_POST['sk_name'] == $sk->user_code) ? 'selected="selected"' : '') ?> value="<?php echo $sk->user_code; ?>"><?php echo $sk->username; ?></option>
                                    <?php endforeach; ?>
                    ...
                    <div class="border border-dark p-4">
                        <div class="form-group row">
                            <label for="" class="col-sm-12 col-form-label">
                                <p style=" color: #ff0000;">Please Re-Type the Password Shown Below and Make sure the User Name is Valid.</p>
                            </label>
                            <div class="col-sm-4">
                                <label for="" class="col-form-label">User Name</label>
                                <input value="<?php echo(isset($_POST['username']) ? $_POST['username'] : '') ?>" type="text" class="form-control" placeholder="User Name" id="username" name='username'>
                                <?php echo form_error('username', '<span class="text-danger">', '</span>'); ?>
                            </div>
                            <div class="col-sm-4">
                                <label for="" class="col-form-label">Password (Min:8, Max:12)</label>
                                <input value="<?php echo(isset($_POST['password']) ? $_POST['password'] : '') ?>" type="password" class="form-control" placeholder="Password" id="password" name='password'>
                                <?php echo form_error('password', '<span class="text-danger">', '</span>'); ?>
                            </div>
                            <div class="col-sm-4">
                                <label for="" class="col-form-label">Confirm Password</label>
                                <input value="<?php echo(isset($_POST['confirm_password']) ? $_POST['confirm_password'] : '') ?>" type="password" class="form-control " placeholder="Confirm Password" name='confirm_password'>
...
<script>
    ...
    $("#role").change(function(){
        if($(this).val() == 'LM'){
            $("#sk_input").show();
            $("#lm_only_location").show();
        }else{
            $("#sk_input").hide();
            $("#lm_only_location").hide();
        }
    });
    ...
    function getSks() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    html += '<option value=' + data[i].user_code + '>' + data[i].username + '</option>';
                }
                $('#sk').html(html);
            }
        });
