...
<div class="row ">
    <div class="col-lg-12 ">
        <div>
            <h5><?php echo $this->lang->line('district'); ?> : <kbd><?php echo $datas['dist_name']; ?></kbd> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('subdivision'); ?> : <kbd><?php echo $datas['sub_div_name']; ?></kbd> &nbsp;&nbsp;&nbsp;&nbsp; <?php echo $this->lang->line('circle'); ?> : <kbd><?php echo $datas['cir_name']; ?></kbd> <?php echo $this->lang->line('vill_town'); ?> : <kbd><?php echo $datas['vill_name']; ?></kbd> </h5>
        </div>
        <div class="card card-info">
            <div class="card-header bg-info text-white">
                <h3 class="card-title text-center font-weight-bold">Dag Flagging</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="" id="PartialMappingForm">
                    ...
                    <div class="row mt-3">
                        <div class="form-group col-md-8">
                            <label>Would you like to mapping all dags with one area flag ? </label>
                            <p style="color:red">NOTE : No need to select dag if you choose yes</p>
                        </div>

                        <div class="form-group col-md-4">
                            <select class="form-control" name="full_map" id="full_map">
                    ...
                    <div class="text-center mt-3">
                        <button class="btn btn-primary" type="button" onclick="openModalForFlag();"><i class="fa fa-check-square-o"></i> Click here for mapping</button>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($insertedMappingDetails as $key => $value) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#" onclick="removeMappingFlag('<?= $value->dag_no; ?>')" class="btn btn-danger btn-sm">Remove <i class="fa fa-trash-o"></i></a> </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
...
<div class="modal" id='myLargeModalLabel' tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            ...
            <div class="modal-body">
                <form id="ajaxMappingForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <b style="font-size:18px"> <textarea class="form-control" readonly="" id="dags_view" style="height: 102px;"></textarea></b>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-4">
                            <label for=""><i class="fa fa-hand-o-right text-green"></i> Area Category</label>
                        </div>
                        <div class="col-md-8">
...
<script type="text/javascript">
    function showSuccessMessage(text) {
        Swal.fire({
            ...
            window.location.href = baseurl + "ChithaFlag/partialmapping?no=<?= $datas['vill_code']; ?>";
        });
...
<script>
    ...
    $(document).ready(function() {
        ...
        function load_data() {
            ...
            $('#datatable thead th:nth-of-type(2)').each(function() {
                ...
                var title = 'Dag No';
                $(this).html('<div class="col-md-12"><div class="col-md-6">Dag No </div><div class="col-md-6"><input type="text" class="input_search form-control form-control-sm" placeholder="Search ' + title + '" data-column-index="0"> </div></div>');
            });
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax': {
                    url: base_url + 'index.php/ChithaFlag/getAllDagsForMapping',
                    type: 'POST',
                    data: {
    ...
    function openModalForFlag() {
        ...
        if ($('#full_map').val() == 'Y') {
            $.ajax({
                url: baseurl + "ChithaFlag/getAllSelectedDags",
                type: 'post',
                dataType: 'json',
                data: {
                ...
                success: function(data) {
                    if (data.responseType == 2) {
                        $("#dags_view").html(data.select_dags.toString());
                        $("#dag_list").val(data.select_dags);
                    } else {
                        showErrorMessage(data.msg);
                        location.reload();
                    }
