    ...
    <div class="col-lg-12 ">
        ...
        <div class="card card-info">
            <div class="card-header bg-success text-white">
                <h3 class="card-title text-center font-weight-bold">Change Dag Flagging</h3>
            </div>
            <div class="card-body">
                <form method="POST" action="" id="PartialMappingForm">
                    ...
                    <h5 class="text-red"><i class="fa fa-hand-o-right text-red"></i> Select dag for change flag by clicking the change button and proceed with Forward to CO button which will appear in below once mapping done.</h5>

                    <div class="container mt-2" style="margin-bottom: 25px;background-color: beige;padding: 18px;">
                        <div class="col-md-6 text-center">
                            <label for="" class="text-danger"><i class="fa fa-hand-o-right text-green"></i> CO Rejection Remarks</label>
                        </div>
                        <div class="col-md-6">
                            <?= $remarks_co; ?>
                        </div>
                    ...
                    <div class="text-center">
                        <button class="btn btn-success" type="button" onclick="openModalForFlag();">Click here for change flag</button>
                    ...
                    <div class="row">
                        <?php if (!empty($insertedMappingDetails)) {  ?>
                            <h5>Revert Mapping List for approval of Circle Officer</h5>
        ...
        <div class="modal-content login">
            ...
            <div class="modal-body">
                <form id="ajaxMappingForm">
                    <h4 style="border-bottom: 5px solid #ff681d;">Change Chitha Dag flag with Area/Zonal Details</h4>
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="text-center">
                        <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-save"></i> Update flag</button>
...
<script type="text/javascript">
    function showSuccessMessage(text) {
        Swal.fire({
            ...
            window.location.href = baseurl + "ChithaFlag/partialmappingRejected?no=<?= $datas['vill_code']; ?>";
        });
    ...
    $('#PartialMappingForm').submit(function(e) {
        ...
        $.ajax({
            url: baseurl + "ChithaFlag/forwardToCORevert",
            type: 'POST',
...
<script>
    ...
    $(document).ready(function() {
        ...
        function load_data() {
            ...
            var table = $('#datatable').DataTable({
                ...
                'ajax': {
                    url: base_url + 'index.php/ChithaFlag/getAllDagsForMappingRevert',
                    type: 'POST',
                    data: {
    ...
    $('#ajaxMappingForm').submit(function(e) {
        ...
        $.ajax({
            url: baseurl + "ChithaFlag/updateMappingWithChitha",
            type: 'POST',
