...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <h1><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Porting History</h1>
            <div class="list-group">
                <?php if(empty($files)): ?>
                    <a class="list-group-item liv-active">No Files Found</a>
                <?php else: ?>
            ...
            <?php else: ?>
                <table id="table-log" class="table table-striped">
                    ...
                    <?php foreach($logs as $key => $log): ?>
                        <tr data-display="stack<?= $key; ?>" class="bg-<?= strtolower($log['class']); ?>">
