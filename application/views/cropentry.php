            ...
            <div class="row bg-light p-0 border border-dark">
                <div class="col-12 px-0 pb-3">
                    <div class="bg-info text-white text-center py-2">
                        <h3>Entry of Crop Details(Col 14-17,20-23,26-29)</h3>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="table-responsive">
                        <table class="table" border=0>
                            ...
                            <tr>
                                <td>Crop Id:</td>
                                <td><input type="text" value="<?php echo $cropId; ?>" class="form-control-sm" id="cropslno" name="cropslno"></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="cropname" id="crop_code">
                                        ...
                                        <?php foreach ($cropnm as $row) { ?>
                                            <option value="<?php echo $row->crop_code; ?>" <?php if ($row->crop_code == $crpnm) { ?> selected <?php } ?>>
                                ...
                                <td>
                                    <select class="form-control" name="cropcatg" id="cropcatg">
                                        ...
                                        <?php foreach ($cropcat as $row) { ?>
                                            <option value="<?php echo $row->crop_categ_code; ?>" <?php if ($row->crop_categ_code == $crpcat) { ?> selected <?php } ?>>
                                ...
                                <td>
                                    <select class="form-control" name="cropseason" id="cropsn">
                                        ...
                                        <?php foreach ($cropsn as $row) { ?>
                                            <option value="<?php echo $row->season_code; ?>" <?php if ($row->season_code == $crpsn) { ?> selected <?php } ?>>
                                ...
                                <td>
                                    <select class="form-control" name="sourcewater" id="watersrc">
                                        ...
                                        <?php foreach ($watersrc as $row) { ?>
                                            <option value="<?php echo $row->water_source_code; ?>" <?php if ($row->water_source_code == $waters) { ?> selected <?php } ?>>
                            ...
                            <?php if (($this->session->userdata('dist_code') == '21') or ($this->session->userdata('dist_code') == '22') or ($this->session->userdata('dist_code') == '23')) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropb" name="croparea_b" value="0"> &nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td>Crop Land Katha:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropk" name="croparea_k" value="0"> &nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td>Crop Land Chatak:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="croplc" name="croparea_lc" value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Crop Land Ganda:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropg" name="croparea_g" value="0">
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                            ...
                            <?php } else { ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropb" name="croparea_b" value="0"> &nbsp;
                                        <span style="color: #D32F2F; padding-left: 5px">Max Size : 32767</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Crop Land Katha:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropk" name="croparea_k" value="0" maxlength="4"> &nbsp;
                                        <span style="color: #D32F2F; padding-left: 5px">Max Size : 4</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Crop Land Lessa:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="croplc" name="croparea_lc" value="0" maxlength="19"> &nbsp;
                                        <span style="color: #D32F2F; padding-left: 5px">Max Size : 19.9</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                ...
                <div class="col-12 text-center pb-3">
                    ...
                    <?php } ?>
                    <input type='button' class="btn btn-primary" id="cropsubmit" name="cropsubmit" value="Submit" onclick="cropentry();"></input>
