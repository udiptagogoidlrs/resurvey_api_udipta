        ...
        <div class="col-lg-4">
            <div class="card height">
                ...
                <div class="card-footer">
                    <a href="<?= base_url('index.php/count/LMCountController/getDataEnteredCountforLMLotWise') ?>" title="Click here for a detailed view" class="card-title"><small class="text-muted"><i class="fa fa-suitcase" aria-hidden="true"></i>
                            <?= $total_count ?></small></a>
                </div>
            </div>
        </div>
