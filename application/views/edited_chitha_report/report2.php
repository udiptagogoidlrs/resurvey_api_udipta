...
<body>
  ...
  <div class="container bg-light p-0 border border-dark mt-5 mb-5">
    ...
    <?php echo form_open('SplittedReportController/generateChitha'); ?>
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
        ...
        <div class="col-sm-6">
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <select class="form-control" id="select_patta_type2" name="patta_code" required>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <select class="form-control dag_no_lower" id="selectlw2" name="dag_no_lower">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-6">
              <select class="form-control" id="selectup2" name="dag_no_upper">
