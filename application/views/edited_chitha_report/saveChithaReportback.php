...
<div class='chitha_report container-fluid'>
    <p align="left" style="margin-top: 0; margin-bottom: 0">
        <font size="4" face="courier">Assam Schedule XXXVII,Form No. 30</font>
    </p>
    <center>
        <p style="margin-top: 0; margin-bottom: 0">
            <font face="Verdana" size="5">Chitha for Surveyed Villages /</font>
        </p>
        <p>
            <font size="5">জৰীপ হোৱা গাঁৱৰ চিঠা</font>
        </p>
        <br>
        ...
        <table class="table" align="center">
            <tr>
                <td width="20%" style="text-align: center;">
                    <!--DISTRICT-->
                    <p>
                        <font size="5" color="#000080">&#2460;&#2495;&#2482;া<b> :<?php echo $location['dist']; ?></b> </font>
                    </p>
                </td>
                <td width="20%" style="text-align: center;">
                    <!--SUB-DIVISION-->
                ...
                <td width="20%" style="text-align: center;">
                    <!--CIRCLE-->
                    <p>
                        <font size="5" color="#000080">&#2458;&#2453;&#2509;&#2544;<b>:<?php echo $location['cir']; ?></b> </font>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td width="20%" style="text-align: center;">
                    <!--lot-->
                    <p>
                        <font size="5" color="#000080">&#2482;&#2494;&#2463;<b>:<?php echo $location['lot']; ?> </b> </font>
                    </p>
                </td>
                <td width="20%" style="text-align: center;">
                    <!--vill-->
                    <p>
                        <font size="5" color="#000080">&#2455;&#2494;&#2451;&#2433;<span>/ </span>&#2458;&#2489;&#2544;<b>: <?php echo $location['vill']; ?> </b> </font>
                    </p>
                </td>
                ...
                <div align="center" class="col-lg-6">
                    <table class="table">
                        <tr style="border-left: 1px solid black;">
                            <td align=center rowspan="2" style="width:50px; border-top-color:#000000; border-top-width:1; border-right: 1px solid black">
                                <!--DAG NUMBER COL. 1-->
                                দাগ নং
                            </td>
                            <td colspan="2" align=center style="width:110px; border-top-color:#000000; border-top-width:1; border-right: 1px solid black">
                                <!--LAND CLASS COL. 2-->
                                মাটিৰ শ্ৰেণী
                            </td>
                            <td align=center rowspan="2" style="width:120px; border-top-color:#000000; border-top-width:1; border-right: 1px solid black">
                                <!--AREA COL. 3-->
                                কালি <p>( বি-ক-লে )</p>
                            </td>
                            ...
                            <td align=center rowspan="2" style="width:75px; border-top-color:#000000; border-top-width:1; border-right: 1px solid black">
                                <!--REVENUE COL.5-->
                                ৰাজহ(টকা)
                            </td>
                            <td align=center rowspan="2" style="width:95px; border-top-color:#000000; border-right: 1px solid black;">
                                <!--LOCAL RATE COL. 6-->
                                স্হানীয় কৰ(টকা)
                            </td>
                        </tr>
                ...
                <div align="center" class="col-lg-12">
                    <table class="table table-bordered" BORDER="1" bordercolor="#000000" STYLE="width:100%; border-collapse:collapse" cellPadding=0 cellSpacing=0 height="580">
                        ...
                        <tr>
                            ...
                            <td align="center" valign="top" width="15%" height="100">কালি (বি-ক-লে)</td>
                        ...
                        <tr>
                            ...
                            <td STYLE="width:40px" align="center" valign="top" height="38">
                                ...
                                <p style="margin-top: 0; margin-bottom: 0">
                                    <font size="3">২য়</font>
                                </p>
                                <p style="margin-top: 0; margin-bottom: 0">
                                    <font size="3">৩য়</font>
                            </td>
                        ...
                        <tr>
                            ...
                            <td rowspan="3" valign="top" height="409" id=chitha_col_9>
                                <!--Tenant Descr.-->
                            ...
                            <td valign="top" rowspan="3" height="409" id=chitha_col_10>
                                <!--Tenant TYPE & NO.-->
                                <?php
                                if (isset($chithainf['tenant'])) {
                                    foreach ($chithainf['tenant'] as $tenantdesc) :
                            ...
                            <td rowspan="3" valign="top" height="409" id=chitha_col_11>
                                <!--Sub Tenant-->
                                <?php
                            ...
                            <!----------------------------1ST YEAR ---------------------------------------->
                            <!----------------------------1ST YEAR ---------------------------------------->
                            <td align="center" valign="top" height="100" id=crop_year_no_1>
                                <!--YEAR NO-->
                                <?php
                            ...
                            <td align="center" valign="top" height="100" id=chitha_col_12>&nbsp;
                                <!--NONCROP TYPE 1st YEAR-->
                                <?php
                            ...
                            <td align="center" valign="top" width="200" height="100" id=chitha_col_13>&nbsp;
                                <!--NONCROP LAND 1st YEAR-->
                            ...
                            <td align="left" valign="top" height="409" rowspan=3 id=chitha_col_30>
                                <!--FRUIT-->
                                <?php
