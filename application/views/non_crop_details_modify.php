            ...
            <div class="row bg-light p-0 border border-dark">
                <div class="col-12 px-0 pb-3">
                    <div class="bg-info text-white text-center py-2">
                        <h3>Edit of Non-agricultural Land use details (Col 12-13,18-19,24-25)</h3>
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="table-responsive">
                        <table class="table" border=0>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" value="<?php echo $nonCropId; ?>" class="form-control form-control-sm" id="ncropslno" name="ncropslno" readonly>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select class="form-control-sm" id="yr" name="yearno">
                                        ...
                                        <option value="<?php echo ($nonCrop->yn); ?>" <?php if ($nonCrop->yn) { ?> selected <?php } ?>>
                                            <?php echo $nonCrop->yn; ?>
                                        </option>
                                ...
                                <td>
                                    <select class="form-control" name="ncropcode" id="ncropcode">
                                        ...
                                        <?php foreach ($ncropnm as $row) { ?>
                                            <option value="<?php echo $row->used_noncrop_type_code; ?>" <?php if ($row->used_noncrop_type_code == $nonCrop->type_of_used_noncrop) { ?> selected <?php } ?>>
                                                <?php echo $row->noncrop_type; ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </td>
                            ...
                            <?php if (($this->session->userdata('dist_code') == '21') || ($this->session->userdata('dist_code') == '22') || ($this->session->userdata('dist_code') == '23')) { ?>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control-sm" id="cropb" name="ncroparea_b" value="<?php echo $nonCrop->noncrop_land_area_b ?>"></td>
                                </tr>
                                <tr>
                                    <td>Non-agri Land Katha:</td>
                                    <td><input type="text" class="form-control-sm" id="cropk" name="ncroparea_k" value="<?php echo $nonCrop->noncrop_land_area_k ?>"></td>
                                </tr>
                                <tr>
                                    <td>Non-agri Land Chatak:</td>
                                    <td><input type="text" class="form-control-sm" id="croplc" name="ncroparea_lc" value="<?php echo $nonCrop->noncrop_land_area_lc ?>"></td>
                                </tr>
                                <tr>
                                    <td>Non-agri Land Ganda:</td>
                                    <td><input type="text" class="form-control-sm" id="cropk" name="ncroparea_k" value="<?php echo $nonCrop->noncrop_land_area_g ?>"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                            ...
                            <?php } else { ?>
                                <tr>
                                    <td>Non-agri Land Bigha:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropb" name="ncroparea_b" value="<?php echo $nonCrop->noncrop_land_area_b ?>">
                                ...
                                <tr>
                                    <td>Non-agri Land Katha:</td>
                                    <td>
                                        <input type="text" class="form-control-sm" id="cropk" name="ncroparea_k" value="<?php echo $nonCrop->noncrop_land_area_k ?>">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control-sm" id="croplc" name="ncroparea_lc" value="<?php echo $nonCrop->noncrop_land_area_lc ?>">
                ...
                <div class="col-12 text-center pb-3">
                    ...
                    <input type='button' class="btn btn-primary" id="cropsubmit" name="cropsubmit" value="Submit" onclick="updateNonCropDetails();"></input>
