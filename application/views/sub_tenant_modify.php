            ...
            <div class="row bg-light p-0 border border-dark">
                <div class="col-12 px-0 pb-3">
                    <div class="bg-info text-white text-center py-2">
                        <h3>Edit of Subtenant Details(Column 9-10)</h3>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="table-responsive">
                        <table class="table" border=0>
                            ...
                            <tr>
                                <td>Subtenant Id:</td>
                                <td><input type="text" class="form-control form-control-sm" id="tid" name="subTenantId" value="<?php echo $tnid; ?>" readonly></td>

                            </tr>
                            <tr>
                                <td>Subtenant Name:<font color=red>*</font>
                                </td>
                                <td><input type="text" class="form-control form-control-sm" id="tname" name="subTenantName" value="<?php echo $tnam; ?>" charset="utf-8" onKeyPress="javascript:convertThis(event)" onKeyDown="toggleKBMode(event)"></td>

                            </tr>
                            <tr>
                                <td>Guardian's Name:<font color=red>*</font>
                                </td>
                                <td><input type="text" class="form-control form-control-sm" id="guard_name" value="<?php echo $tfam; ?>" name="subTenantsFather" charset="utf-8" onKeyPress="javascript:convertThis(event)" onKeyDown="toggleKBMode(event)"></td>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Address line1:</td>
                                <td><input type="text" class="form-control form-control-sm" id="add1" name="subTenants_add1" value="<?php echo $tadd1; ?>" charset="utf-8" onKeyPress="javascript:convertThis(event)" onKeyDown="toggleKBMode(event)"></td>
                            </tr>
                            <tr>
                                <td>Address line2:</td>
                                <td><input type="text" class="form-control form-control-sm" id="add2" name="subTenants_add2" value="<?php echo $tadd2; ?>" charset="utf-8" onKeyPress="javascript:convertThis(event)" onKeyDown="toggleKBMode(event)"></td>
                            </tr>
                            <tr>
                                <td>Address line3:</td>
                                <td><input type="text" class="form-control form-control-sm" id="add3" name="subTenants_add3" value="<?php echo $tadd3; ?>" charset="utf-8" onKeyPress="javascript:convertThis(event)" onKeyDown="toggleKBMode(event)"></td>
                            </tr>
                ...
                <div class="col-12 text-center pb-3">
                    ...
                    <input type='button' class="btn btn-primary" id="msubmit" name="msubmit" value="Submit" onclick="subTenantModify();"></input>
