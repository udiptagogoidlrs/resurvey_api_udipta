...
class RemarkModel extends CI_Model {
    ...
    public function master_property_types() {
        return $this->db->get('master_property_types')->result();
    }
    public function master_occupations() {
        return $this->db->get('master_occupations')->result();
    }
    public function master_casts() {
        return $this->db->get('master_caste')->result();
    }
    public function master_genders() {
...
//      }
    ...
    function get_lmnotes()
    {
        ...
        return $this->db->from('chitha_rmk_lmnote')
        ->where([
            'chitha_rmk_lmnote.dist_code' => $dist_code,
            'chitha_rmk_lmnote.subdiv_code' => $subdiv_code,
            'chitha_rmk_lmnote.cir_code' => $cir_code,
            'chitha_rmk_lmnote.mouza_pargona_code' => $mouza_pargona_code,
            'chitha_rmk_lmnote.lot_no' => $lot_no,
            'chitha_rmk_lmnote.vill_townprt_code' => $vill_townprt_code,
            'chitha_rmk_lmnote.dag_no' => $dag_no
        ])->join('lm_code','lm_code.lm_code = chitha_rmk_lmnote.lm_code and lm_code.dist_code=chitha_rmk_lmnote.dist_code and 
        lm_code.subdiv_code=chitha_rmk_lmnote.subdiv_code and lm_code.cir_code=chitha_rmk_lmnote.cir_code
        and lm_code.mouza_pargona_code=chitha_rmk_lmnote.mouza_pargona_code
        and lm_code.lot_no=chitha_rmk_lmnote.lot_no','left')
        ->get()->result();
    }
