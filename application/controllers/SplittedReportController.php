...
class SplittedReportController extends CI_Controller
{
    use CommonTrait;
    ...
    {
        parent::__construct();
        $this->load->model('chitha/EditedChithaModel');
    ...
    public function location()
    {
        ...
        $data['_view'] = 'edited_chitha_report/location';
    ...
    public function generateDagChitha($is_redirect  = false)
    {
        ...
        $daginfo = $this->EditedChithaModel->getDagforchitha($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, 0);
        //var_dump ($daginfo);
        $daginformation['dagrange'] = $daginfo;
        $pattatype = $this->EditedChithaModel->pattatypeforchitha();
        ...
        $chithadetailsmain['_view'] = 'edited_chitha_report/report2';
    ...
    public function index()
    {
        ...
        $this->load->view('edited_chitha_report/report1', $district);
    ...
    public function districtDetails()
    {
        ...
        $this->load->helper('html');
        $this->load->view('header');
        $this->load->view('edited_chitha_report/report1');
        $this->load->view('footer');
    }
    ...
    public function districtDetails_dc_lao()
    {
        ...
        $this->load->helper('html');
        $this->load->view('header');
        $this->load->view('edited_chitha_report/reportdclao');
        $this->load->view('footer');
    }
    ...
    public function jamadistrictDetails_dc_lao()
    {
        ...
        $this->load->helper('html');
        $this->load->view('header');
        $this->load->view('edited_chitha_report/JamaAutoUpdate');
        $this->load->view('footer');
    }
    ...
    public function districtDetails32()
    {
        ...
        $this->load->helper('html');
        $this->load->view('header');
        $this->load->view('edited_chitha_report/report1new');
        $this->load->view('footer');
    }
    ...
    public function districtDetails32dclao()
    {
        ...
        $this->load->helper('html');
        $this->load->view('header');
        $this->load->view('edited_chitha_report/reportnewdclao');
        $this->load->view('footer');
    }
    ...
    public function generateDagChitha32()
    {
        ...
        $this->load->view('edited_chitha_report/report2new', $chithadetailsmain);
        $this->load->view('footer');
    }
    ...
    public function getDags($p)
    {
        ...
        if ($p == 0000) {
            $daginfo = $this->EditedChithaModel->getDagforchithaAll($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code);
        } else {
            $daginfo = $this->EditedChithaModel->getDagforchitha1111($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $p);
        }
    ...
    public function getDagMiscCase($p, $dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $pno)
    {
        ...
        $daginfo = $this->EditedChithaModel->getDagforchithaMiscCase($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $p, $pno);
        $json = array();
    ...
    public function getDagslower($l, $p)
    {
        ...
        if ($p == 0000) {
            $daginfo = $this->EditedChithaModel->getDagforALLchithalower($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $l);
        } else {
            $daginfo = $this->EditedChithaModel->getDagforchithalower($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $l, $p);
        }
    ...
    public function getPattalower($l, $p, $dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code)
    {
        ...
        if ($p == 0000) {
            $daginfo = $this->EditedChithaModel->getPattaforALLchithalower($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $l);
        } else {
            $daginfo = $this->EditedChithaModel->getPattaforchithalower($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_code, $l, $p);
        }
    ...
    public function generateChitha()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $pattatype['chithaPattatypeinfo'] = $this->EditedChithaModel->getpattatype($patta_code);
            $this->session->set_userdata(array('patta_type' => $pattatype['chithaPattatypeinfo'][0]->patta_type));

            //        if ($patta_code != '0000')
            //        {
            //            $chithainfo1['data'] = $this->EditedChithaModel->getchithaDetails123($district_code, $subdivision_code, $circlecode, $mouzacode, $lot_code, $village_code, $dag_no_lower, $dag_no_upper, $patta_code);
            //
            //        } else {
            //              $chithainfo1['data'] = $this->EditedChithaModel->getchithaDetailsALL($district_code, $subdivision_code, $circlecode, $mouzacode, $lot_code, $village_code, $dag_no_lower, $dag_no_upper);
            //        }
            ...
            $maindataforchitha['_view'] = 'edited_chitha_report/saveChithaReport';
    ...
    public function modalgenerateChitha()
    {
        if (isset($_GET['case_no'])) {
            ...
            if ($patta_code != '0000') {
                ...
                $chithainfo1['chithainfo'] = $this->EditedChithaModel->getchithaDetails2($district_code, $subdivision_code, $circlecode, $mouzacode, $lot_code, $village_code, $dag_no_lower, $dag_no_upper);
            }

            $maindataforchitha = array_merge($data, $secondSelection, $chithainfo1, $pattatype);
            //var_dump ($maindataforchitha);
            $content = $this->load->view('edited_chitha_report/saveChithaReport', $maindataforchitha);
            /* $this->load->library('pdf');
              $this->pdf->load_view('edited_chitha_report/saveChithaReport', $maindataforchitha,true);
              $this->pdf->render();
    ...
    public function generateChithaCitizen()
    {
        ...
        $maindataforchitha = array_merge($data, $secondSelection, $chithainfo1, $pattatype);
        //  var_dump($data);
        $this->load->view('edited_chitha_report/saveChithaReport', $maindataforchitha);
        $this->load->view('footer');
    }
    ...
    public function generateChithaRegistration()
    {
        ...
        $content = $this->load->view('edited_chitha_report/saveChithaReport', $maindataforchitha, true);
    ...
    public function generateChithaforSro()
    {
        ...
        if ($patta_code != '0000') {
            ...
            $chithainfo1['data'] = $this->EditedChithaModel->getchithaDetailsALL($district_code, $subdivision_code, $circlecode, $mouzacode, $lot_code, $village_code, $dag_no_lower, $dag_no_upper);
            //$chithainfo1['data'] = $this->EditedChithaModel->getchithaDetails2($district_code, $subdivision_code, $circlecode, $mouzacode, $lot_code, $village_code, $dag_no_lower, $dag_no_upper);
            //var_dump($chithainfo1);
        }
