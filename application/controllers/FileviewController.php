...
class FileviewController extends CI_Controller
{
    /**
     * Author: Udipta Gogoi
     * Date: 26-Dec-22
    ...
    private $folderPath = APPPATH . 'file_write/';
     ...
     * @var string
     */
    private $viewName = "view_file_writes";
    ...
    public function viewByFileName($file_name){
        ...
        if(!is_null($file_name)) {
            $currentFile = $this->folderPath . "/" . basename($file_name);
        }else if(!empty($files)) {
    ...
    public function showFileWrites() {
